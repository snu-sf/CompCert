...
- (* Icall *)
  exploit find_function_translated; eauto. intros [tf [FIND' [sprog' [Hsprog' TRANSF']]]]. 
  econstructor; split.
...
Proof.
  intros. inversion H. 
  exploit funct_ptr_translated; eauto. intros [tf [A [sprog [Hsprog B]]]].
...
(* new *)       (Htrans: CSE.transf_program rtlprog1 = OK rtlprog2):
(* new *)   @sepcomp_rel
(* new *)     Language.Language_RTL Language.Language_RTL
(* new *)     (fun p f tf => CSE.transf_function (romem_for_program p) f = OK tf)
