...
(* new *)     (fun p f tf => Inlining.transf_function (funenv_program p) f = OK tf)
...
(* call *)
  ...
  exploit find_function_agree; eauto. intros [fd' [A [sprog' [SPROG' B]]]].
  exploit tr_funbody_inv; eauto. intros TR; inv TR.
(* not inlined *)
  left; econstructor; split.
...
(* new *)       (Htrans: Inlining.transf_program rtlprog1 = OK rtlprog2):
(* new *)   @sepcomp_rel
(* new *)     Language.Language_RTL Language.Language_RTL
(* new *)     (fun p f tf => Inlining.transf_function (Inlining.funenv_program p) f = OK tf)
