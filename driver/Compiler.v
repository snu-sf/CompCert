...
Proof.
  ...
  apply compose_forward_simulation with (RTL.semantics p11).
    apply Inliningproof.transf_program_correct; auto. apply Inliningproof.Inlining_sepcomp_rel. eassumption.
  ...
  apply compose_forward_simulation with (RTL.semantics p2).
    apply total_if_simulation. intros. apply Constpropproof.transf_program_correct. apply Constpropproof.Constprop_sepcomp_rel. eauto.
  ...
  apply compose_forward_simulation with (RTL.semantics p3).
    eapply partial_if_simulation; eauto. intros. apply CSEproof.transf_program_correct. apply CSEproof.CSE_sepcomp_rel. eassumption.
  apply compose_forward_simulation with (RTL.semantics p31).
    eapply partial_if_simulation; eauto. intros. apply Deadcodeproof.transf_program_correct. apply Deadcodeproof.Deadcode_sepcomp_rel. eassumption.
